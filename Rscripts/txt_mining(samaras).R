...
text2 <- readLines("samaras.txt", encoding = defaultEncoding)
...
findAssocs(tdm, c("θα"), corlimit = 0.50)

# find correlation of term "πρέπει" with other terms
findAssocs(tdm, c("πρέπει"), corlimit = 0.5)

# find correlation of term "ελλάδα" with other terms
findAssocs(tdm, c("ελλάδα"), corlimit = 0.4)

# find correlation of term "μέτρα" with other terms
findAssocs(tdm, c("μέτρα"), corlimit = 0.45)
...
txt <- readLines ("samaras.txt", encoding = defaultEncoding)
